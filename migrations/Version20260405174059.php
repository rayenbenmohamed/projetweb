 ...
 */
final class Version20260405174059 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contract CHANGE end_date end_date DATE DEFAULT NULL, CHANGE salaire_net salaire_net DOUBLE PRECISION DEFAULT NULL, CHANGE status status VARCHAR(50) NOT NULL, CHANGE is_signed is_signed TINYINT(1) NOT NULL, CHANGE signed_at signed_at DATETIME DEFAULT NULL, CHANGE google_event_id_start google_event_id_start VARCHAR(255) DEFAULT NULL, CHANGE google_event_id_end google_event_id_end VARCHAR(255) DEFAULT NULL, CHANGE google_event_id_trial google_event_id_trial VARCHAR(255) DEFAULT NULL, CHANGE contract_type_id type_contrat_id INT DEFAULT NULL, CHANGE job_offer_id job_offre_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE interview CHANGE status status VARCHAR(50) NOT NULL, CHANGE notes notes LONGTEXT DEFAULT NULL, CHANGE meeting_link meeting_link VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE job_application CHANGE application_status application_status VARCHAR(50) NOT NULL, CHANGE apply_date apply_date DATETIME NOT NULL, CHANGE cover_letter cover_letter LONGTEXT DEFAULT NULL, CHANGE cv_path cv_path VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE user ADD discr VARCHAR(255) NOT NULL, CHANGE firstName firstName VARCHAR(255) DEFAULT NULL, CHANGE lastName lastName VARCHAR(255) DEFAULT NULL, CHANGE email email VARCHAR(180) NOT NULL, CHANGE phone phone VARCHAR(20) DEFAULT NULL, CHANGE password password VARCHAR(255) NOT NULL, CHANGE companyname companyname VARCHAR(255) DEFAULT NULL, CHANGE Departement departement VARCHAR(255) DEFAULT NULL, CHANGE two_factor_code two_factor_code VARCHAR(10) DEFAULT NULL, CHANGE two_factor_expiry two_factor_expiry DATETIME DEFAULT NULL, CHANGE reset_token reset_token VARCHAR(100) DEFAULT NULL, CHANGE reset_token_expiry reset_token_expiry DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contract CHANGE end_date end_date DATE DEFAULT \'NULL\', CHANGE salaire_net salaire_net DOUBLE PRECISION DEFAULT \'NULL\', CHANGE status status VARCHAR(50) DEFAULT \'\'\'En Attente\'\'\', CHANGE is_signed is_signed TINYINT(1) DEFAULT 0, CHANGE signed_at signed_at DATETIME DEFAULT \'NULL\', CHANGE google_event_id_start google_event_id_start VARCHAR(255) DEFAULT \'NULL\', CHANGE google_event_id_end google_event_id_end VARCHAR(255) DEFAULT \'NULL\', CHANGE google_event_id_trial google_event_id_trial VARCHAR(255) DEFAULT \'NULL\', CHANGE job_offre_id job_offer_id INT NOT NULL, CHANGE type_contrat_id contract_type_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE interview CHANGE status status VARCHAR(50) DEFAULT \'\'\'Prévue\'\'\' NOT NULL, CHANGE notes notes TEXT DEFAULT NULL, CHANGE meeting_link meeting_link VARCHAR(255) DEFAULT \'NULL\'');
        ...
        $this->addSql('ALTER TABLE job_application CHANGE application_status application_status VARCHAR(50) DEFAULT \'\'\'Pending\'\'\', CHANGE apply_date apply_date DATETIME DEFAULT \'current_timestamp()\', CHANGE cover_letter cover_letter TEXT DEFAULT NULL, CHANGE cv_path cv_path VARCHAR(255) DEFAULT \'NULL\'');
        ...
        $this->addSql('ALTER TABLE `user` DROP discr, CHANGE email email VARCHAR(50) NOT NULL, CHANGE password password VARCHAR(50) NOT NULL, CHANGE firstName firstName VARCHAR(100) NOT NULL, CHANGE lastName lastName VARCHAR(100) NOT NULL, CHANGE phone phone VARCHAR(20) DEFAULT \'NULL\', CHANGE two_factor_code two_factor_code VARCHAR(10) DEFAULT \'NULL\', CHANGE two_factor_expiry two_factor_expiry DATETIME DEFAULT \'NULL\', CHANGE reset_token reset_token VARCHAR(100) DEFAULT \'NULL\', CHANGE reset_token_expiry reset_token_expiry DATETIME DEFAULT \'NULL\', CHANGE companyname companyname VARCHAR(255) DEFAULT \'NULL\', CHANGE departement Departement VARCHAR(255) DEFAULT \'NULL\'');
    }
}
